module.exports = function ({ api, models }) {
    ...
    var day = moment.tz("Asia/Dhaka").day();  // বাংলাদেশ সময় ব্যবহার
    ...
    (async function () {
        ...
        try {
            ...
            logger.loader(global.getText('listen', 'loadedEnvironmentUser')), logger(global.getText('listen', 'successLoadEnvironment'), '[ Rasel Mahmud ]');
        } catch (error) {
    ...
    //FUNCTION WORKS AS IT'S NAME, CRE: RASEL MAHMUD
    const monthToMSObj = {
        1: 31 * 24 * 60 * 60 * 1000,
        2: 28 * 24 * 60 * 60 * 1000,
        3: 31 * 24 * 60 * 60 * 1000,
